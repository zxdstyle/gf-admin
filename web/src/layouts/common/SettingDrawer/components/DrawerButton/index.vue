<template>
    <n-button
        ...
        class="fixed top-1/2 right-0 z-10000 w-42px h-42px !p-0 transition-all duration-300 rounded-bl-lg rounded-tl-lg"
        @click="app.toggleSettingdrawerVisible"
    >
        <icon-ant-design-close-outlined v-if="app.settingDrawerVisible" class="text-24px" />
        <icon-ant-design-setting-outlined v-else class="text-24px animate-spin" />
    </n-button>
</template>
